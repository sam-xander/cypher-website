        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
          ...
          <div>
            <p className="mt-8 max-w-5xl lg:mx-auto text-lg text-[#e6e6e6] text-opacity-60 sm:text-xl md:mt-5 md:max-w-3xl">
              Discord is the lifeblood of an NFT project. However, it&apos;s a
              prime target for scams and hacks. Within seconds a project can
              lose all credibility and trust, alongside thousands of dollars
              when a server is compromised.
            </p>
            <p className="mt-8 max-w-5xl lg:mx-auto text-lg text-[#e6e6e6] text-opacity-60 sm:text-xl md:mt-5 md:max-w-3xl">
              Our team of security experts can help ease the pressure and keep
              your community and funds safe with personalized consultancy.
            </p>
