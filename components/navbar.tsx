                      ...
                      <a
                        ...
                        className={classNames(
                          router.route === item.href
                            ? "text-xs bg-transparent rounded-3xl border-2 border-[#113C5A] text-[#e6e6e6] uppercase hover:bg-[#344250] hover:border-transparent"
                            : "self-center text-xs rounded-3xl bg-[#113C5A] text-[#e6e6e6] uppercase hover:bg-[#344250]",
