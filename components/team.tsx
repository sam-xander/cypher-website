...
export default function Team() {
  return (
    <>
      <div className="mx-auto mt-20 sm:mt-40 py-12 px-4 md:max-w-7xl sm:px-8 lg:px-8 lg:py-24">
        <a id="team"></a>
        <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
          <div>
            ...
            <p className="mt-8 max-w-5xl lg:mx-auto text-lg text-[#e6e6e6] text-opacity-60 sm:text-xl md:mt-5 md:max-w-3xl">
              We&apos;re building the future of Cypher, scaling our services for
              NFT projects and building our community of smarter investors.
            </p>
          </div>
          <div className="lg:col-span-2">
            <ul
              role="list"
              className="space-y-12 md:grid md:grid-cols-2 md:gap-x-6 md:gap-y-12 md:space-y-0 lg:gap-x-8"
            >
              {people.map((person) => (
                <li key={person.name}>
                  <div className="space-y-8">
                    ...
                    <div className="text-lg leading-6 font-medium space-y-2">
                      <h3 className="text-[#e6e6e6] uppercase">
                        {person.name}
                      </h3>
                      <p className="text-[#92DDFD] opacity-80 uppercase">
                        {person.role}
                      </p>
                    </div>
                    <div className="text-lg">
                      <p className="text-[#e6e6e6] opacity-60">{person.bio}</p>
                      <p className="text-[#e6e6e6] opacity-60 mt-5">
                        {person.bio2}
                      </p>
                    </div>
