      ...
      <div className="mx-auto max-w-7xl w-full pt-12 pb-12 text-left lg:py-48 lg:text-left">
        <div className="tracking-wide px-6 lg:w-1/2 sm:px-8 xl:pr-16">
          ...
          <p className="mt-8 max-w-5xl lg:mx-auto text-lg text-[#e6e6e6] text-opacity-60 sm:text-2xl md:max-w-3xl">
            Improve fundamentals, increase brand awareness, build confidence and
            improve security.
          </p>
          <p className="mt-6 max-w-5xl lg:mx-auto text-lg text-[#e6e6e6] text-opacity-60 sm:text-2xl md:mt-8 md:max-w-3xl">
            Our NFT assessments provide value to projects and investors. We
            assess pre-mint and post-mint projects across 8 areas and over 100
            data points. Projects receive a comprehensive report including
            strengths, weaknesses and suggested improvements.
          </p>
          <Button href="/nft-assessment" classNames={""} label={""} />
        </div>
      </div>
